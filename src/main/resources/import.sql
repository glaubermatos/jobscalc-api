...
insert into job (id, closed_at, created_at, hours_estimate, name, profile_id, project_value, status, working_hours_per_day) values (2, null, CURRENT_TIMESTAMP(), 72000, 'Los Hermanos site', 1, 125000, 'NOTSTARTED', 7200)
